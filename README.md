...
The voice server will be using live kit. We are planning on releasing the voice system we have built. We have yet to finalise all its functionality and we will be releasing this when it is feature complete.
